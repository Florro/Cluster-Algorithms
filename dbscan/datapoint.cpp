...
ClusterState Datapoint::getState(void) const
{
  return state;
}

unsigned int Datapoint::getID(void) const
{
  return ID;
}

int Datapoint::getClusterID(void) const
{
  return clusterID;
}

unsigned int Datapoint::getSize(void) const
{
